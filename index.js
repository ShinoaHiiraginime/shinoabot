...
global.tqto = `rimuru\nGalang\nManu\nIvan\nYogi\nNino\nAqull\nSenku\nMySelf\nYukii\nDappuhy`,
global.descBiz = `Developer Of Shinoa~bot\nPrograming Otodidak💻`, 
...
if (plugin.botAdmin && !botGroupAdmins) return
  ...
  let settingstatus = 0;
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await rimuru.setStatus(`Aktif Selama: ${uptime} | Mode: ${banChats ? "SELF-MODE" : "PUBLIC-MODE"} | Shinoa~bot`).catch((_) => _);
